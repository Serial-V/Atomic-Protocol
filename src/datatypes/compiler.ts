...
Write.uuid = [
    'native',
    (value: string, buffer: Buffer, offset: number) => {
...
Write.restBuffer = [
    'native',
    (value: Buffer, buffer: Buffer, offset: number) => {
...
Read.encapsulated = [
    ...
    (
        compiler: any,
        { lengthType, type }: { lengthType: string; type: string; }
    ) => {
...
Write.byterot = [
    'context',
    (value: number, buffer: Buffer, offset: number) => {
